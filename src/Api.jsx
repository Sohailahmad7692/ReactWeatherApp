...
function ApiCall(props){
    ...
    useEffect(
    function tempchange(){
    let rawdata=fetch(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=${props.cityName}&appid=420ddd5f335ad29e7a6f3d9dd895656b`)
    rawdata.then(
        function(res){
            return res.json()
        })
